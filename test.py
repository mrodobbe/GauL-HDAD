...
representations, all_molecules, all_conformers = load_representations(molecules, conformers,
                                                                      save_folder, conformer_distinction=True)
heavy = [heavy_atoms(mol) for mol in all_molecules]
...
test_results_to_logfile(all_conformers, ensemble_prediction, ensemble_sd,
